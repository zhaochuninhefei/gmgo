...
//
// ToDeprecated: use Attributes in Address instead.
...
const (
	...
	//
	// ToDeprecated: to select the GRPCLB load balancing policy, use a service
...
type Address struct {
	...
	//
	// ToDeprecated: use Attributes instead.
	Type AddressType
