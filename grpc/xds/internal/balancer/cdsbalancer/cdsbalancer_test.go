...
import (
	...
	"gitee.com/zhaochuninhefei/gmgo/grpc/xds/internal/balancer/clusterresolver"
	...
	_ "gitee.com/zhaochuninhefei/gmgo/grpc/xds/internal/balancer/ringhash" // Register the ring_hash LB policy
)
