...
import (
	...
	_ "gitee.com/zhaochuninhefei/gmgo/grpc/xds/internal/balancer/outlierdetection" // To register helper functions which register/unregister Outlier Detection LB Policy.
)
