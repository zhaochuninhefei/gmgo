...
var signatureAlgorithmDetails = []struct {
	...
	// TODO 添加SM2相关签名算法定义
	{x509.SM2WithSM3, oidSignatureSM2WithSM3, x509.SM2, x509.SM3},
}

// TODO(rlb): This is also from crypto/x509, so same comment as AGL's below
func signingParamsForPublicKey(pub interface{}, requestedSigAlgo x509.SignatureAlgorithm) (hashFunc x509.Hash, sigAlgo pkix.AlgorithmIdentifier, err error) {
	...
	case *ecdsa.PublicKey:
		...
		case elliptic.P384():
			hashFunc = x509.SHA384
			sigAlgo.Algorithm = oidSignatureECDSAWithSHA384
		case elliptic.P521():
			hashFunc = x509.SHA512
			sigAlgo.Algorithm = oidSignatureECDSAWithSHA512
		default:
			err = errors.New("x509: unknown elliptic curve")
		}
	default:
		err = errors.New("x509: only SM2, RSA or ECDSA keys supported")
	}
