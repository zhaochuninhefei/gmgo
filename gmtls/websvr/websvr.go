...
// // SM2配置
// func loadGMConfig() (*gmtls.Config, error) {
...
// func loadServerConfig() (*gmtls.Config, error) {
// 	sigCert, err := gmtls.LoadX509KeyPair(sm2SignCertPath, sm2SignKeyPath)
// 	if err != nil {
// 		return nil, err
// 	}
...
// 		return nil, err
// 	}
// 	rsaCert, err := gmtls.LoadX509KeyPair(rsaCertPath, rsaKeyPath)
// 	if err != nil {
// 		return nil, err
// 	}
// 	return &gmtls.Config{
// 		Certificates: []gmtls.Certificate{sigCert, encCert, rsaCert},
// 	}, nil
// }

// 切换GMSSL/TSL
func loadAutoSwitchConfig(needClientAuth bool) (*gmtls.Config, error) {
	...
	// }
	// 返回自动切换的配置
	config, err := gmtls.NewBasicAutoSwitchConfig(&sigCert, &rsaKeypair)
	if err != nil {
		return nil, err
	}
