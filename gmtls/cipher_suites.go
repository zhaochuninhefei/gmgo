...
// TODO 添加对应go1.17.5的"cipher_suites.go"
// CipherSuite is a TLS cipher suite. Note that most functions in this package
// accept and expose cipher suite IDs instead of this type.
type CipherSuite17 struct {
	ID   uint16
	Name string
...
func CipherSuites() []*CipherSuite17 {
	return []*CipherSuite17{
...
func InsecureCipherSuites() []*CipherSuite17 {
