...
var pkcs8P224PrivateKeyHex = ``
...
var pkcs8P256PrivateKeyHex = ``
...
var pkcs8P384PrivateKeyHex = ``
...
var pkcs8P521PrivateKeyHex = ``
...
func TestOnlyPKCS8(t *testing.T) {
	privKey, _ := ecdsa.GenerateKey(elliptic.P256(), rand.Reader)
	der, err := MarshalPKCS8PrivateKey(privKey)
	if err != nil {
		t.Errorf("进行MarshalPKCS8PrivateKey失败 %v", err)
		return
	}
	privKey2, err := ParsePKCS8PrivateKey(der)
	if err != nil {
		t.Errorf("进行ParsePKCS8PrivateKey失败 %v", err)
		return
	}
...
func TestPKCS8(t *testing.T) {
	...
	for _, test := range tests {
		...
		if !bytes.Equal(derBytes, reserialised) {
			...
			//fmt.Printf("derBytes: %x\n", derBytes)
			//fmt.Printf("reserialised: %x\n", reserialised)
			continue
		}
	}
}
